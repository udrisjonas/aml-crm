    ...
    <div className="p-8">
      ...
      <div className="flex flex-wrap gap-3 mb-6">
        <input
          ...
          className="flex-1 min-w-[200px] max-w-sm px-3.5 py-2 rounded-lg border border-slate-300
        ...
        {(search || riskFilter || kycFilter) && (
          <button
            ...
            className="px-3.5 py-2 text-sm text-slate-500 hover:text-slate-700 transition-colors"
          >
            Clear
          </button>
        )}
        ...
        <div className="bg-white rounded-xl border border-slate-200 overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-slate-50 border-b border-slate-200">
              <tr>
                <th className="text-left px-6 py-3.5 font-medium text-slate-500 text-xs uppercase tracking-wider">
                  Name
                </th>
                <th className="text-left px-6 py-3.5 font-medium text-slate-500 text-xs uppercase tracking-wider">
                  Type
                ...
                return (
                  <tr key={client.id} className="hover:bg-slate-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      ...
                      >
                        {client.risk_rating === "not_assessed" ? "Not assessed" : client.risk_rating}
                      </span>
                    </td>

                    {/* KYC status */}
                    <td className="px-6 py-4">
                      <span className={`px-2.5 py-0.5 rounded-full text-xs font-medium ${kycInfo.className}`}>
                        {kycInfo.label}
                      </span>
                    </td>
