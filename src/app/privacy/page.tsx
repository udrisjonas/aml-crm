  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <h1 className="text-3xl font-bold text-slate-900 mb-2">Privatumo politika / Privacy Policy</h1>
        <p className="text-slate-400 text-sm mb-10">Paskutinį kartą atnaujinta / Last updated: 2025-01-01</p>
        <div className="prose prose-slate max-w-none text-slate-600 space-y-6">
          <p>Šis puslapis bus papildytas privatumo politika. / This page will be updated with a full privacy policy.</p>
          <p>
