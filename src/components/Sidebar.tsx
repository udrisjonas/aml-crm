  ...
  function NavContent() {
    return (
      <>
        ...
        {/* User footer — pinned, never pushed off screen */}
        <div className="shrink-0 px-3 py-3 border-t border-neutral-100 space-y-0.5">
  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-3 left-3 z-40 w-10 h-10 flex items-center justify-center
          bg-white border border-neutral-200 rounded-lg shadow-sm text-neutral-600"
      ...
      >
        ...
        <button
          ...
          className="absolute top-3 right-3 w-8 h-8 flex items-center justify-center rounded-lg
            text-neutral-500 hover:bg-neutral-100 transition-colors z-10"
      ...
      <aside className="hidden lg:flex w-60 bg-white border-r border-neutral-200 flex-col min-h-screen shrink-0">
        <NavContent />
      </aside>
    </>
  );
